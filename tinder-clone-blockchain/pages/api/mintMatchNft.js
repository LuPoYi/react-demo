...
const mintMatchNft = async (req, res) => {
  ...
  const walletWithProvider = new ethers.Wallet(process.env.RINKEBY_PRIVATE_KEY, provider)

  const contract = new ethers.Contract(TINDER_ADDRESS, TINDER_ABI, walletWithProvider)
